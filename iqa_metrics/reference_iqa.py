...
def compute_psnr(img1, img2, value_range=1.0):
    """
    Computes Peak Signal-to-Noise Ratio between two images.
    :param img1: image 1
    :param img2: image 2
    :param value_range: the maximum possible pixel value of the images.
                        For 8-bit images, range is 255.0; 1.0 for float images
    :return: psnr value
    """
    mse = compute_mse(img1, img2)
    return 10.0 * np.log10(value_range * value_range / mse)
